...
class SipinHome extends CI_Controller {
    ...
    */
    public function log($Type, $detil, $username) {
        $dataLog = array('detail_log' => $username . $detil, 'log_type' => $Type . $username, 'created_date' => $this->date_time_now(), 'created_by' => $username);
...
>>>>>>> 38a131de72e0665b6c754e173b568c5c9b6ec0e2
        ...
        if (!isset($get_passw->row()->password)) {
            ...
            if ($get_passw->row()->password != $password) {
                ...
                if ($get_passw->row()->status_user == 0) {
                    ...
                    $this->session->set_userdata(array('id_user' => $get_passw->row()->id_user, 'username' => $get_passw->row()->username, 'email' => $get_passw->row()->email, 'status_user' => $get_passw->row()->status_user, 'survey_status' => $get_passw->row()->survey_status, 'status' => 'login'));
...
>>>>>>> 38a131de72e0665b6c754e173b568c5c9b6ec0e2
    ...
    */
    ...
    public function send_complaint() {
        ...
        $data = array('id_user' => $cek[0]['id_user'], 'complaint_details' => $this->input->post('message'), 'created_date' => $this->date_time_now(), 'created_by' => $cek[0]['username']);
